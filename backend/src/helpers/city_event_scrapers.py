...
def scrape_events_temple(parsed_html: 'BeautifulSoup', home_url:str) -> list: #ToDO: fix parsed_html type it is BeautifulSoup Obj
...
def scrape_city_events(city_name:str)-> list:
    ...
    city_urls = extract_json_city_urls()
